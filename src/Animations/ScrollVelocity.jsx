...
export const ScrollVelocity = ({
	...
	function VelocityText({
		...
		return (
			<div className={`${parallaxClassName} relative overflow-hidden`} style={parallaxStyle}>
				<motion.div
					className={`${scrollerClassName} flex text-center font-sans text-[3rem] font-bold whitespace-nowrap drop-shadow md:text-[1rem] md:leading-6`}
	...
	return (
		<section>
			...
			>
				En mi portafolio se encontrará toda mi información basica, personal y profesional. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
			</VelocityText>
		</section>
	);
};
